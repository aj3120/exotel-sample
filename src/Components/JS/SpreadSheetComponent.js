...
class SpreadSheet extends Component {
    ...
    addColumnLeft = (e) => {
        ...
        this.setState({ field_selected: ' ', spread_data: new_spread_data })
    }
    ...
    sortColumnAtoZ = (e) => {
        ...
        spread_data_temp = spread_data_temp.sort((a, b) => {
            if (a[this.state.field_selected] !== '') {
                if (b[this.state.field_selected].toUpperCase() >= a[this.state.field_selected].toUpperCase() || b[this.state.field_selected] !== '')
                    return -1
                return 1
            }
            else {
        ...
        this.setState({ field_selected: ' ', spread_data: spread_data_temp })
    }
